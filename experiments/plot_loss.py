...
fig.add_trace(
    go.Scatter(x=xx+xx[::-1], y=y_upp+y_low[::-1], fillcolor="rgba(99,110,250,0.5)", fill='tozerox', line={"color":"rgba(99,110,250,0)"},showlegend=False )
)
fig.add_trace(
    go.Scatter(x=xx, y=means, line={"color":"rgba(99,110,250,1)"}, name="Average text MAE (val)")
)
fig.update_layout(
