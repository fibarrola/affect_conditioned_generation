...
def add_xmp_data(nombrefichero, prompts=None, iter=-1, model_name='unspecified', seed=-1, input_images='unspeficied'):
    ...
    imagen.xmp.append_array_item(libxmp.consts.XMP_NS_DC, 'i', str(iter), {"prop_array_is_ordered":True, "prop_value_is_array":True})
...
def add_stegano_data(filename, prompts=None, iter=-1, model_name='unspecified', seed=-1, input_images='unspeficied'):
    data = {
